...
public class CoordinatorPopupMenu extends PopupMenu {
    ...
    public CoordinatorPopupMenu(@NonNull Context context, @NonNull View anchor) {
        super(context, anchor);
    }

    public CoordinatorPopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        super(context, anchor, gravity);
    }

    public CoordinatorPopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, int popupStyleAttr, int popupStyleRes) {

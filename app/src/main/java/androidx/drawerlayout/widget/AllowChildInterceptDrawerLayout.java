...
public class AllowChildInterceptDrawerLayout extends DrawerLayout {
    ...
    public static final String TAG = "AllowChildInterceptDrawerLayout";
    ...
    public AllowChildInterceptDrawerLayout(@NonNull Context context,@Nullable AttributeSet attrs,int defStyleAttr) {
